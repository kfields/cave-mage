...
from cave_mage.dialogs.pause import PauseDialog
from cave_mage.dialogs.beatlevel import BeatLevelDialog
...
class Level(Scene):
    ...
    def update(self, delta_time):
        ...
        if cave_mage.globe.player.level_beat:
            self.beat_level()
            cave_mage.globe.player.level_beat = False
