...
from crunge.engine.d2.renderer.render_pipeline_2d import RenderPipeline2D

from ...cave_mage_program import CaveMageProgram
...
@klass.singleton
class SparksProgram(CaveMageProgram):
    def __init__(self):
        super().__init__()
